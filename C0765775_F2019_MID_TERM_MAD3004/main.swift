...
var net = Internet(providerName: "Fido", gbUsed: 26.5, billId: "M0FD1", billDate: result, billAmount: 100, billType: Bill.billing.Internet)
...
var net1 = Internet(providerName: "bell", gbUsed: 12, billId: "B0bl1", billDate: result, billAmount: 98, billType: Bill.billing.Internet)
